...
load("@git_and_stuff//private/pkg:dpkg_status.bzl", "dpkg_status")
load("@git_and_stuff//private/pkg:debian_spdx.bzl", "debian_spdx")
load("@git_and_stuff//private/util:merge_providers.bzl", "merge_providers")
